...
if __name__ == '__main__':
    ...
    class Agent:
        def __init__(self, action_space):
            ...
            self.model = PPO.load('/workingdirectory/model_save_ppo13/best_model_115000.zip')
            #self.model = TD3.load('/workingdirectory/model_save_td3/best_model_8000.zip')
...
# python client.py --url https://competition2.cgilab.nctu.edu.tw/12344